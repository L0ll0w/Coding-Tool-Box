...
document.addEventListener('DOMContentLoaded', function () {
  var commonLifeContainer = document.querySelector('#common-life-container');
  ...
  var modalForm = document.getElementById('create-task-modal'); // Assurez-vous que ce modal a l'ID "create-task-modal"
  var taskForm = document.getElementById('taskForm');
  var tasksContainer = document.getElementById('tasksContainer');
  var modalTitle = document.getElementById('modalTitle');
  var taskIdInput = document.getElementById('taskId');
  var overrideMethodInput = document.getElementById('overrideMethod');
    ...
    taskForm.addEventListener('submit', function (e) {
      ...
      fetch(url, {
        ...
        if (taskIdInput.value) {
          ...
          if (taskCard) {
            var cardTitleElement = taskCard.querySelector('.card-title');
            if (cardTitleElement) {
              cardTitleElement.textContent = data.title;
            }
            var cardBodyP = taskCard.querySelector('.card-body p');
            if (cardBodyP) {
  ...
  if (tasksContainer) {
    tasksContainer.addEventListener('click', function (e) {
      ...
      if (e.target && e.target.classList.contains('edit-btn')) {
        ...
        console.log("DEBUG: Found card attributes:", {
          id: id,
          title: title,
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _CommonLife__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./CommonLife */ "./resources/js/CommonLife.js");
/* harmony import */ var _CommonLife__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_CommonLife__WEBPACK_IMPORTED_MODULE_0__);
